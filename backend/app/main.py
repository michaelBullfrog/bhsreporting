...
<body>
  <header class="topbar">
    ...
    <nav class="nav"><a href="/executive-overview">Executive</a><a class="active" href="/staffing">Staffing</a><a href="/call-demand">Call Demand</a><a href="/service-sla">Service / SLA</a><a href="/missed-callbacks">Missed & Callbacks</a><a href="/inbound-outbound">Call Activity</a></nav><div class="bhs-logo-wrap"><img class="bhs-header-logo" src="/static/bhs_logo.png" alt="BHS Corrugated logo"></div>
  </header>
...
<header class="topbar">
  ...
  <nav class="nav"><a href="/executive-overview">Executive</a><a href="/staffing">Staffing</a><a class="active" href="/call-demand">Call Demand</a><a href="/service-sla">Service / SLA</a><a href="/missed-callbacks">Missed & Callbacks</a><a href="/inbound-outbound">Call Activity</a></nav><div class="bhs-logo-wrap"><img class="bhs-header-logo" src="/static/bhs_logo.png" alt="BHS Corrugated logo"></div>
</header>
...
async function loadHealthStatus(){
  ...
  try{
    ...
    dot.className=`health-dot health-${h.status||'no_data'}`;
    const names={healthy:'Healthy',delayed:'Delayed',stale:'Stale',no_data:'No data'};
    label.textContent=`Data status: ${names[h.status]||h.status}`;
    freshness.textContent=h.age_minutes==null?'No stored timestamp':`Freshness: ${h.age_minutes} min old`;
    if(h.newest_data_ms){
      updated.textContent=`Data through: ${new Date(Number(h.newest_data_ms)).toLocaleString()}`;
    }else{
...
<header class="topbar">
  <div class="brand"><div><div class="brand-title">BHS Corrugated</div><div class="brand-sub">Contact Center Analytics</div></div></div>
  <nav class="nav"><a href="/executive-overview">Executive</a><a href="/staffing">Staffing</a><a href="/call-demand">Call Demand</a><a class="active" href="/service-sla">Service / SLA</a><a href="/missed-callbacks">Missed & Callbacks</a><a href="/inbound-outbound">Call Activity</a></nav><div class="bhs-logo-wrap"><img class="bhs-header-logo" src="/static/bhs_logo.png" alt="BHS Corrugated logo"></div>
</header>
...
function renderHours(rows){
  ...
  rows.forEach(r=>{
    if(r.date!==lastDate){
      ...
      html.push(`<tr><td colspan="7" style="text-align:left;background:#edf4f9;font-weight:850;color:var(--brand-dark);padding:7px 12px">${label}</td></tr>`);
      lastDate=r.date;
    }
    html.push(`<tr>
...
<div class="topbar">
  <div class="brand"><div><div class="brand-title">BHS Corrugated</div><div class="brand-sub">Contact Center Analytics</div></div></div>
  <nav class="nav"><a href="/executive-overview">Executive</a><a href="/staffing">Staffing</a><a href="/call-demand">Call Demand</a><a href="/service-sla">Service / SLA</a><a class="active" href="/missed-callbacks">Missed & Callbacks</a><a href="/inbound-outbound">Call Activity</a></nav><div class="bhs-logo-wrap"><img class="bhs-header-logo" src="/static/bhs_logo.png" alt="BHS Corrugated logo"></div>
</div>
<main class="page">
...
setDefaults();loadData();loadHealthStatus();
</script>
</body></html>
"""
...
<div class="topbar">
  <div class="brand"><div><div class="brand-title">BHS Corrugated</div><div class="brand-sub">Contact Center Analytics</div></div></div>
  <nav class="nav"><a href="/executive-overview">Executive</a><a href="/staffing">Staffing</a><a href="/call-demand">Call Demand</a><a href="/service-sla">Service / SLA</a><a href="/missed-callbacks">Missed & Callbacks</a><a class="active" href="/inbound-outbound">Call Activity</a></nav><div class="bhs-logo-wrap"><img class="bhs-header-logo" src="/static/bhs_logo.png" alt="BHS Corrugated logo"></div>
</div>
<main class="page">
  <section class="health-strip">
    <div class="health-left">
...
<div class="topbar">
  <div class="brand"><div><div class="brand-title">BHS Corrugated</div><div class="brand-sub">Contact Center Analytics</div></div></div>
  <nav class="nav"><a class="active" href="/executive-overview">Executive</a><a href="/staffing">Staffing</a><a href="/call-demand">Call Demand</a><a href="/service-sla">Service / SLA</a><a href="/missed-callbacks">Missed & Callbacks</a><a href="/inbound-outbound">Call Activity</a></nav><div class="bhs-logo-wrap"><img class="bhs-header-logo" src="/static/bhs_logo.png" alt="BHS Corrugated logo"></div>
</div>
<main class="page">
  <section class="health-strip">
    <div class="health-left">
