...
from ..services.metrics import overview, agent_summary, staffing_summary, call_demand_summary, service_sla_summary, missed_callbacks_summary, inbound_outbound_summary, executive_overview_summary, dashboard_health_summary
...
BACKEND_VERSION = "8.5.3"

@router.get("/version")
def get_version():
    return {
        "backend_version": BACKEND_VERSION,
        "staffing_route": "v8.5.3-default-last-30-days",
    }
