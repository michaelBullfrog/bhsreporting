...
class WxccClient:
    def __init__(self):
        ...
        self.access_token = settings.wxcc_access_token
    ...
    def _search(self, query: str, from_ms: int, to_ms: int) -> dict:
        # Tenant/API testing showed >1 day windows can be rejected.
        ...
        with httpx.Client(timeout=60) as client:
            resp = client.post(f"{self.base_url}/search", headers=self.headers, json=payload)
