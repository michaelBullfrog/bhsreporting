...
<body>
<div class="topbar">
  <div class="brand"><div class="mark" style="width:auto;min-width:66px;padding:0 10px;letter-spacing:.08em">BHS</div><div><div class="brand-title">BHS Corrugated</div><div class="brand-sub">Contact Center Analytics</div></div></div>
