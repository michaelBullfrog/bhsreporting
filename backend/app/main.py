...
def home():
    ...
    <body>
      <main class="shell">
        ...
        <div class="status">Dashboard backend v8.1</div>
      </main>
    </body>
    </html>
    """
...
h1{margin:0;font-size:30px}.subtitle{margin-top:5px;color:var(--muted);font-size:14px}.policy{margin-top:6px;color:var(--muted);font-size:12px}
.filters{background:var(--panel);border:1px solid var(--line);border-radius:16px;padding:16px;display:grid;grid-template-columns:minmax(160px,1fr) minmax(160px,1fr) auto;gap:12px;align-items:end;box-shadow:var(--shadow);margin-bottom:18px}
.field label{display:block;font-size:11px;text-transform:uppercase;letter-spacing:.07em;font-weight:800;color:var(--muted);margin-bottom:6px}input{width:100%;border:1px solid var(--line);border-radius:10px;padding:10px 11px;background:#fff}.btn{border:0;border-radius:10px;padding:11px 16px;background:var(--brand);color:#fff;font-weight:800;cursor:pointer}
...
<div class="topbar">
  <div class="brand"><div class="mark">B</div><div><div class="brand-title">Bullfrog Analytics</div><div class="brand-sub">Webex Contact Center</div></div></div>
  <nav class="nav"><a class="active" href="/executive-overview">Executive</a><a href="/staffing">Staffing</a><a href="/call-demand">Call Demand</a><a href="/service-sla">Service / SLA</a><a href="/missed-callbacks">Missed & Callback</a><a href="/inbound-outbound">Call Activity</a></nav>
</div>
<main class="page">
  <div class="heading-row">
