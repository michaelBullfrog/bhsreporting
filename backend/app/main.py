...
def home():
    ...
    <body>
      <main class="shell">
        ...
        <div class="status">Dashboard backend v5.4</div>
      </main>
    </body>
    </html>
    """
...
<div class="modal-backdrop" id="modal">
  <div class="modal-card">
    ...
    <div class="defs">
      ...
      <div class="def"><strong>Long-Wait Breach</strong><p>A queued interaction whose queue wait exceeds the fixed 300-second (5-minute) threshold.</p></div><div class="def"><strong>Reported Abandoned</strong><p>For this dashboard, queued interactions that are neither answered nor explicitly abandoned are folded into the abandoned count. The API still keeps raw abandoned and other-outcome counts separately for auditability.</p><span class="formula">Reported Abandoned = Raw Abandoned + Other Outcomes</span></div>
...
function renderInsights(o){
  const items=[
    ...
    ['Reporting Abandon Logic',`${o.raw_abandoned} raw abandoned + ${o.other_outcomes} other = ${o.abandoned} reported abandoned`],
  ];
