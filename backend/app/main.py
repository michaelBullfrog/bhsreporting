...
def home():
    ...
    <body>
      <main class="shell">
        ...
        <div class="status">Dashboard backend v6.5</div>
      </main>
    </body>
    </html>
    """
...
<main class="page">
  <div class="heading-row">
    <div><h1>Missed Calls & Callbacks</h1><div class="subtitle">Track missed queue calls, native courtesy callback resolution, and still unresolved after 24 hours.</div><div class="policy">Unresolved aging threshold: 24 hours · Native courtesy callbacks only</div></div>
  ...
  <section class="kpis">
    ...
    <div class="kpi"><div class="kpi-label">Still Needing Follow-Up</div><div id="unresolved" class="kpi-value">—</div><div class="kpi-foot">still needs follow-up</div></div>
    <div class="kpi"><div class="kpi-label">Still Open After 24 Hours</div><div id="over24" class="kpi-value">—</div><div class="kpi-foot">still unresolved after 24 hours</div></div>
  ...
  <section class="panel">
    ...
    <div class="table-wrap"><table>
      <thead><tr><th>Queue</th><th>Queued</th><th>Missed</th><th>Missed Rate</th><th>Missed Calls Called Back</th><th>Unresolved</th><th>Resolution Rate</th></tr></thead>
...
function renderSummary(o){
  const rows=[
    ...
    ['Still Needing Follow-Up',`${o.unresolved}`],
