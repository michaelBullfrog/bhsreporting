...
from ..services.metrics import overview, agent_summary, staffing_summary, call_demand_summary, service_sla_summary, missed_callbacks_summary, inbound_outbound_summary
...
def get_version():
    return {
        ...
        "staffing_route": "v7.3-call-activity-format-cleanup",
    }
